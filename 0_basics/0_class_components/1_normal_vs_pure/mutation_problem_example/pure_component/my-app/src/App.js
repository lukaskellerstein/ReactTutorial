...
class SomeRandomText extends React.PureComponent {
  // -----------------
  ...
  // 2. - SHOULD NOT BE USED FOR PURE COMPONENT -
  //    - PureComponent is doing 'Shallow Comparison' for you
  ...
  getSnapshotBeforeUpdate(prevProps, prevState) {
    console.log(
      "SomeRandomText - getSnapshotBeforeUpdate",
      prevProps,
      prevState
    );
    return prevState;
...
class SomeListOfWords extends React.PureComponent {
  render() {
    return <div>{this.props.words.join(",")}</div>;
  }
}

class SomeDeepObject extends React.PureComponent {
  render() {
