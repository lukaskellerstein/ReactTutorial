...
// Fix 1. - custom HOC
// ----------------------------------------------------------------
const LoginFormWithErrors = withErrors(LoginForm);
const ProductsPageWithErrors = withErrors(ProductsPage);
  ...
  if (isLogged) {
      ...
      <>
        ...
        <div className="page">
          {selectedPage === "products" && (
            <ProductsPageWithErrors theme={themeState} />
          )}
    ...
    whatToShow = (
      <div className="login-form">
        <LoginFormWithErrors theme={themeState} onLogin={onLogin} />
      </div>
    );
  }
